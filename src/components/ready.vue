  ...
  <div class="email-wrapper">
    ...
    <div class="email-header d-xl-flex align-items-center">
      <div class="d-flex align-items-center">
        ...
        <div class="">
          <button @click='pageto()' type="button" class="btn btn-white ms-2">
...
export default {
  ...
  methods: {
    ...
    del:function(){
      ...
      this.message.index = '';
      this.head = '';
      var a = this.items.indexOf(this.tablename)
  ...
  pageto:function(){
    location.href ='http://127.0.0.1:1234/ready_creat/' + this.tablename
  }
},
